...
def parse_args():
    ...
    ###### only for test ######
    # args.test_file = 'HW2/data/test.json'
    # args.pad_to_max_length = True
    # args.out_put_jsonl = 'HW2/data/prediction.jsonl'
    # args.text_column = 'maintext'
    # args.use_slow_tokenizer = True
    # args.model_name_or_path = 'HW2/HW2_training_result'
    ###### only for test ######
...
def main():
    ...
    for step, batch in enumerate(test_dataloader):
        with torch.no_grad():
            ...
            #     references=decoded_labels,
            # )
            # prediction.append(decoded_preds)
    ...
    # result = metric.compute(use_stemmer=True)
    # result = {k: round(v * 100, 4) for k, v in result.items()}
    with open(args.out_put_jsonl, 'w') as jsonl_file:
        for item in data:
